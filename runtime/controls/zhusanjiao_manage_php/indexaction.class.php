<?php
	class IndexAction extends Common {
		...
		function main()
		{
			$visitor=file_get_contents('viditor.c');
			$visitor=explode('|',$visitor.'|1');
			
			if(isset($_POST['visitor']))
			{
				file_put_contents('viditor.c',$_POST['visitor'].'|'.$visitor[1]);
				$this->assign('alert',1);
			}
			...
			$this->assign('visitor',$visitor[0]);
			$this->assign('tvisitor',$visitor[1]);
