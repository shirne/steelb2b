<?php /* Smarty version 2.6.18, created on 2011-11-29 17:57:00
...
<tr>
	<td height="40" colspan="2" style="background:url(images/top_bg.png) left top repeat-x">
    	<p class="right"><font color="#999">欢迎您</font>&nbsp;<font color="#aa0000"><?php echo $_SESSION['admin_name']; ?>
</font>&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['root']; ?>
/index.php">网站主页</a><a href="<?php echo $this->_tpl_vars['app']; ?>
">管理首页</a><a href="<?php echo $this->_tpl_vars['app']; ?>
/index/cgpwd" target="main">修改密码</a><a href="javascript:void(main.location.reload())">刷新本页</a><a href="<?php echo $this->_tpl_vars['app']; ?>
/index/loginout">退出登陆</a></p>
...
/sys" target="main">网站基本设置</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/index/main" target="main">管理首页</a></li>
                	</ul>
    			</li>
                <li class="mcla"><span>资讯管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news" target="main">市场介绍</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news/index/cid/2" target="main">配套服务</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news/list1" target="main">综合资讯</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news/list1/cid/4" target="main">行情快递</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news/list2" target="main">钢材知识</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/news/cate" target="main">分类管理</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>会员管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user" target="main">普通会员管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user/auth" target="main">认证会员管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user/ask" target="main">待认证会员</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user/add" target="main">添加会员</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user/spec" target="main">入驻企业</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/user/specadd" target="main">添加企业</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>产品管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/product" target="main">产品管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/product/add" target="main">添加产品</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/product/cate" target="main">产品分类</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>信息管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/info/index/type/1" target="main">供应信息</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/info" target="main">求购信息</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/info/add" target="main">添加信息</a></li>
                    </ul>
                </li>
...
/job/add" target="main">添加招聘</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/job" target="main">招聘列表</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>交互管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/mlist" target="main">留言管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/nlist" target="main">公告管理</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>管理员管理</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/manage" target="main">管理员列表</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/manage/#add" target="main">添加管理员</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/manage/datamgr" target="main">数据库管理</a></li>
                    </ul>
                </li>
                <li class="mcla"><span>其它选项</span>
                	<ul>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other" target="main">价格管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/clist" target="main">钢市管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/adlist" target="main">广告管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/alist" target="main">地区管理</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/flist" target="main">友情链接</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['app']; ?>
/other/ulist" target="main">常用链接</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    </td>
    <td valign="top" height="100%" ><iframe name="main" id="main" width="100%" height="100%" frameborder="0" src="<?php echo $this->_tpl_vars['app']; ?>
/index/main"></iframe></td>
</tr>
</table>
