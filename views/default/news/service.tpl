<{include file="public/top.tpl"}>
	<div class="wraper">
    	<div id="position">您现在的位置:<a href="<{$app}>">网站首页</a>&gt;&gt;<a href="<{$app}>/news/service">配套服务</a>&gt;&gt;<{$cont.title}></div>
    </div>
        ...
        <div class="left" id="left_column">
        	<div class="menus">
            	<ul>
                	...
                	<li><a href="<{$app}>/news/service/id/<{$list[ls].id|string_format:"%d"}>"><{$list[ls].title}></a></li>
                    <{/section}>
                </ul>
            </div>
            <!--广告
