<{include file="public/top.tpl"}>
    <div class="wraper">
    	<div id="position">您现在的位置:<a href="<{$app}>/">网站首页</a>&gt;&gt;<a href="<{$app}>/product">供求专版</a>&gt;&gt;用户信息列表</div>
    </div>
    ...
    <div class="wraper">
        ...
        <thead>
            <tr>
                <td colspan="9"><{$com.company}>供应信息列表</td>
            </tr>
            <tr>
                <td>品名</td>
                <td>材质</td>
        ...
        <tbody>
            ...
            <tr>
                <td><{$list[ls].title}><{if $list[ls].type}><span class="orange">[供应]</span><{else}><span class="green">[求购]</span><{/if}></td>
        ...
        <table class="info">
        	<caption><strong><{$com.qa_user}></strong>　　<{if $com.filt}><font color="green">[已认证]</font><{else}><font color="#777777">[未认证]</font><{/if}></caption>
            <tr>
