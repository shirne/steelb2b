<{include file="public/top.tpl"}>
    ...
    <table>
        ...
        <tr>
        	<td>
                ...
                <a <{if $cate[ct].id == $sid }>class="red"<{else}>href="<{$app}>/news/list1/cid/<{$cid}>/sid/<{$cate[ct].id}>" <{/if}> ><{$cate[ct].name}></a>
                <{sectionelse}>
	...
	<table>
    	<caption>所有<font color="red"><{$model}></font><{$submodel}>文章列表<a href="<{$app}>/news/addnews/cid/<{$sid}>">[添加文章]</a></caption>
    	<thead>
        	<tr>
