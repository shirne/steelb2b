<{include file="public/top.tpl"}>
	...
	<table>
    	<caption>所有<font color="red"><{$model}></font>文章列表<a href="<{$app}>/news/addnews/cid/<{$cid}>">[添加文章]</a></caption>
    	<thead>
        	<tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<{$app}>/news/lact/id/<{$nlist[a].id}>/act/0">[删除]</a><a href="<{$app}>/news/modify/id/<{$nlist[a].id}>">[修改]</a></td>
            </tr>
            <{sectionelse}>
            <tr>
